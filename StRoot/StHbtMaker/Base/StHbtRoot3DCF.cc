...
ClassImp(StHbtRoot3DCF)
    ...
    StHbtRoot3DCF::StHbtRoot3DCF(char* aHTitle, int aNBinsX, double aHLoX, double aHHiX, int aNBinsY, double aHLoY,
                                 double aHHiY, int aNBinsZ, double aHLoZ, double aHHiZ)
    : StHbtCorrFctn(),
      StHbtNamed(),
      mHLo(aHLoX),
      mHHi(aHHiX),
