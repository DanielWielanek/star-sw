...
inline const StHbtLorentzVector* StHbtThPair::GetRealMomentum1() const { return mMomentum1; };
inline const StHbtLorentzVector* StHbtThPair::GetRealMomentum2() const { return mMomentum2; };
...
inline const StHbtLorentzVector* StHbtThPair::GetEmPoint1() const { return mEmPoint1; };
inline const StHbtLorentzVector* StHbtThPair::GetEmPoint2() const { return mEmPoint2; };
inline int StHbtThPair::GetPid1() const { return mPid1; };
inline int StHbtThPair::GetPid2() const { return mPid2; };
inline const StHbtPair* StHbtThPair::GetMeasPair() const { return mMeasPair; };
...
inline void StHbtThPair::SetWeight(StHbtFsiWeight* aWeight) { mWeight = aWeight; };
inline double StHbtThPair::RealQInv() const { return abs(*mMomentum1 - *mMomentum2); }

inline void StHbtThPair::setPairPurity(double aPairPurity) { mPairPurity = aPairPurity; }
...
inline StHbtLorentzVector const* StHbtThPair::getMomentum1() const { return mMomentum1; };
inline StHbtLorentzVector const* StHbtThPair::getMomentum2() const { return mMomentum2; };
inline StHbtLorentzVector const* StHbtThPair::getEmPoint1() const { return mEmPoint1; };
inline StHbtLorentzVector const* StHbtThPair::getEmPoint2() const { return mEmPoint2; };
inline int StHbtThPair::getPid1() const { return mPid1; };
inline int StHbtThPair::getPid2() const { return mPid2; };

inline double StHbtThPair::QInv() const { return abs((*mMomentum1) - (*mMomentum2)); }
