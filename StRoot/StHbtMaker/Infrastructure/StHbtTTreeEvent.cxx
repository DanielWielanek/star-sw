...
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
StHbtTTreeEvent::StHbtTTreeEvent(const StHbtEvent* event, StHbtTrackCut* trackCut, StHbtV0Cut* v0Cut, StHbtXiCut* xiCut,
                                 StHbtKinkCut* kinkCut) {
   try {
      initClonesArrays();
      fillEventInfo(event);
   } catch (StException e) {
   ...
   // loop over tracks
   if (mDebug)
      cout << "StHbtTTreeEvent::StHbtTTreeEvent(...) - now fill " << event->TrackCollection()->size() << " tracks"
           << endl;
   ...
   // loop over v0s
   if (mDebug)
      cout << "StHbtTTreeEvent::StHbtTTreeEvent(...) - now fill " << event->V0Collection()->size() << " v0s" << endl;
   ...
   // loop over xis
   if (mDebug)
      cout << "StHbtTTreeEvent::StHbtTTreeEvent(...) - now fill " << event->XiCollection()->size() << " xis" << endl;
   ...
   // loop over kinks
   if (mDebug)
      cout << "StHbtTTreeEvent::StHbtTTreeEvent(...) - now fill " << event->KinkCollection()->size() << " kinks"
           << endl;
...
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
void StHbtTTreeEvent::fill(const StHbtEvent* event, StHbtTrackCut* trackCut, StHbtV0Cut* v0Cut, StHbtXiCut* xiCut,
                           StHbtKinkCut* kinkCut) {
   clear();
   try {
      fillEventInfo(event);
...
void StHbtTTreeEvent::fillEventInfo(const StHbtEvent* event) {
   ...
   if (!event) throw StExceptionNullPointer("StHbtTTreeEvent::fillEventInfo(StHbtEvent* event) - event");
