...
inline void StHbtV0::SetTrackTopologyMapPos(unsigned int word, const unsigned long& m) {
   mTrackTopologyMapPos[word] = m;
}
inline void StHbtV0::SetTrackTopologyMapNeg(unsigned int word, const unsigned long& m) {
   mTrackTopologyMapNeg[word] = m;
}
