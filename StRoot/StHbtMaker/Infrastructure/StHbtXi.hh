...
inline int StHbtXi::tpcHitsBac() const { return mTpcHitsBac; }
...
inline void StHbtXi::SetTrackTopologyMapBac(unsigned int word, const unsigned long& m) {
   mTopologyMapBachelor[word] = m;
}
