...
double StHbtCoulomb::GetRadius() { return (mRadius); }
...
double StHbtCoulomb::CoulombCorrect(const double& eta, const double& radius) {
...
double StHbtCoulomb::Eta(const StHbtPair* pair) {
   ...
   dv = ::sqrt((vx1cms - vx2cms) * (vx1cms - vx2cms) + (vy1cms - vy2cms) * (vy1cms - vy2cms) +
...
double StHbtCoulomb::CoulombCorrect(const double& mass, const double& charge, const double& radius,
                                    const double& qInv) {
   mRadius = radius;
   mZ1Z2 = charge;
