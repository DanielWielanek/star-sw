...
StHbtVertexAnalysis::StHbtVertexAnalysis(const StHbtVertexAnalysis& a) : StHbtAnalysis() {
   ...
   if (mFirstParticleCut) {
      ...
      cout << " StHbtVertexAnalysis::StHbtVertexAnalysis(const StHbtVertexAnalysis& a) - first particle cut set "
           << endl;
   }
   if (mSecondParticleCut) {
      SetSecondParticleCut(mSecondParticleCut);  // this will set the myAnalysis pointer inside the cut
      cout << " StHbtVertexAnalysis::StHbtVertexAnalysis(const StHbtVertexAnalysis& a) - second particle cut set "
           << endl;
   }
   if (mPairCut) {
   ...
   for (iter = a.mCorrFctnCollection->begin(); iter != a.mCorrFctnCollection->end(); iter++) {
      cout << " StHbtVertexAnalysis::StHbtVertexAnalysis(const StHbtVertexAnalysis& a) - looking for correlation "
              "functions "
           << endl;
      ...
      if (fctn)
         ...
         cout << " StHbtVertexAnalysis::StHbtVertexAnalysis(const StHbtVertexAnalysis& a) - correlation function not "
                 "found "
              << endl;
   }
