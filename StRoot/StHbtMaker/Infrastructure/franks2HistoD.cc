...
// constructor
// ***********
franks2HistoD::franks2HistoD(const char* c1, const char* c2, int xbins, double xmin, double xmax, int ybins,
...
// deconstructor
// *************
franks2HistoD::~franks2HistoD() { delete vec; }
// ******************************
...
double franks2HistoD::GetBinCenter(int bin) {
   double center = 0;
   if (bin >= 0 && bin < mXbins) center = mXmin + (0.5 + bin) * mXstep;
   return center;
}
// *************************************************************************************************
