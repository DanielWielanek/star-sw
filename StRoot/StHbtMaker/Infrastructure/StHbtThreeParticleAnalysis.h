...
inline StHbtSectoredPicoEventCollection* StHbtThreeParticleAnalysis::SectoredMixingBuffer() {
...
// Set's
inline bool StHbtThreeParticleAnalysis::AnalyzeIdenticalParticles() {
   return ((mFirstParticleCut == mSecondParticleCut) && (mSecondParticleCut == mThirdParticleCut));
}
inline void StHbtThreeParticleAnalysis::SetTripletCut(StHbtTripletCut* x) {
   mTripletCut = x;
   x->SetAnalysis((StHbtBaseAnalysis*)this);
}
inline void StHbtThreeParticleAnalysis::AddCorrFctn(StHbtCorrFctn* cf) {
   mCorrFctnCollection->push_back(cf);
   cf->SetAnalysis((StHbtBaseAnalysis*)this);
}
inline void StHbtThreeParticleAnalysis::SetEventCut(StHbtEventCut* x) {
   mEventCut = x;
   x->SetAnalysis((StHbtBaseAnalysis*)this);
}
inline void StHbtThreeParticleAnalysis::SetFirstParticleCut(StHbtParticleCut* x) {
   mFirstParticleCut = x;
   x->SetAnalysis((StHbtBaseAnalysis*)this);
}
inline void StHbtThreeParticleAnalysis::SetSecondParticleCut(StHbtParticleCut* x) {
   mSecondParticleCut = x;
   x->SetAnalysis((StHbtBaseAnalysis*)this);
}
inline void StHbtThreeParticleAnalysis::SetThirdParticleCut(StHbtParticleCut* x) {
   mThirdParticleCut = x; /*x->SetAnalysis((StHbtBaseAnalysis)this);*/
}
...
inline void StHbtThreeParticleAnalysis::SetCalcCosPhi(const char* x) {
   ...
   mCosPhiE = new StHbt1DHisto("CosPhiE", "Error Histo", mCosPhi->GetNbinsX(), mCosPhi->GetXaxis()->GetBinUpEdge(0),
                               mCosPhi->GetXaxis()->GetBinUpEdge(mCosPhi->GetNbinsX()));
}
...
inline bool StHbtThreeParticleAnalysis::SectoredMixingBufferFull() {
