...
StHbtTriplet::StHbtTriplet(StHbtParticle* a, StHbtParticle* b, StHbtParticle* c) : mTrack1(a), mTrack2(b), mTrack3(c) {}
...
double StHbtTriplet::kT() const {
   double tmp = (mTrack1->FourMomentum() + mTrack2->FourMomentum() + mTrack3->FourMomentum()).perp();
   tmp /= 3.0;
