...
int StHbtIOBinary::readHeader(StHbtString& header) { return readString(header); }

int StHbtIOBinary::writeHeader(const StHbtString& header) { return writeString(header); }
...
int StHbtIOBinary::read(StHbtEvent& ev, unsigned short evVersion, unsigned short trVersion, unsigned short v0Version) {
   if (mDebug)
      cout << " StHbtIOBinary::read(StHbtEvent& ev, ...) - Versions: " << evVersion << " " << trVersion << " "
           << v0Version << endl;
   int iret;
   byteCounterEvent = 0;
   switch ((int)evVersion) {
      case 0:
         iret = read_V0(ev, trVersion, v0Version);
         break;
      case 1:
         iret = read_V1(ev, trVersion, v0Version);
         break;
      case 2:
         iret = read_V2(ev, trVersion, v0Version);
         break;
      default:
         iret = ioERR;
   ...
   if (mDebug)
      cout << " StHbtIOBinary::read(StHbtEvent& ev, ...) - byteCounterTotal= " << byteCounterTotal
           << "  byteCounterEvent = " << byteCounterEvent << endl;
   return iret;
}

//------------------------- StHbtEvent -----------------------------------
int StHbtIOBinary::write(const StHbtEvent& ev, unsigned short evVersion, unsigned short trVersion,
                         unsigned short v0Version) {
   if (mDebug)
      cout << " StHbtIOBinary::write(StHbtEvent& ev, ...) -  Versions: " << evVersion << " " << trVersion << " "
           << v0Version << endl;
   int iret;
   byteCounterEvent = 0;
   switch ((int)evVersion) {
      case 0:
         iret = write_V0(ev, trVersion, v0Version);
         break;
      case 1:
         iret = write_V1(ev, trVersion, v0Version);
         break;
      case 2:
         iret = write_V2(ev, trVersion, v0Version);
         break;
      default:
         iret = ioERR;
   ...
   byteCounterTotal += byteCounterEvent;
   if (mDebug)
      cout << "  StHbtIOBinary::write(StHbtEvent& ev, ...) - byteCounterTotal= " << byteCounterTotal
           << "  byteCounterEvent = " << byteCounterEvent << endl;
   return iret;
}
...
int StHbtIOBinary::write_V0(const StHbtEvent& ev, unsigned short trVersion, unsigned short v0Version) {
   if (mDebug)
      cout << " StHbtIOBinary::write_V0(const StHbtEvent& ev, unsigned short trVersion, unsigned short v0Version) "
           << endl;
   int iret;
   int idummy = 0;
   // event properties
...
int StHbtIOBinary::write_V1(const StHbtEvent& ev, unsigned short trVersion, unsigned short v0Version) {
   if (mDebug)
      cout << " StHbtIOBinary::write_V1(const StHbtEvent& ev, unsigned short trVersion, unsigned short v0Version) "
           << endl;
   int iret;
   // event properties
   iret = write(ev.mEventNumber);
...
int StHbtIOBinary::write_V2(const StHbtEvent& ev, unsigned short trVersion, unsigned short v0Version) {
   if (mDebug)
      cout << " StHbtIOBinary::write_V2(const StHbtEvent& ev, unsigned short trVersion, unsigned short v0Version)"
           << endl;
   int iret;
   // event properties
   iret = write(ev.mEventNumber);
