...
std::complex<double> StHbtYlm::Ceiphi(double phi) { return (std::complex<double>(cos(phi), sin(phi))); }

double StHbtYlm::Legendre(int ell, double ctheta) { return (gsl_sf_legendre_Pl(ell, ctheta)); }
...
double StHbtYlm::ReYlm(int ell, int m, double theta, double phi) { return (real(StHbtYlm::Ylm(ell, m, theta, phi))); }

double StHbtYlm::ImYlm(int ell, int m, double theta, double phi) { return (imag(StHbtYlm::Ylm(ell, m, theta, phi))); }

double StHbtYlm::ReYlm(int ell, int m, double x, double y, double z) { return (real(StHbtYlm::Ylm(ell, m, x, y, z))); }

double StHbtYlm::ImYlm(int ell, int m, double x, double y, double z) { return (imag(StHbtYlm::Ylm(ell, m, x, y, z))); }
