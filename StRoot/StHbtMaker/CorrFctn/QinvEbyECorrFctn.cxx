...
//____________________________
void QinvEbyECorrFctn::AddRealPair(const StHbtPair* pair) { mNumerator->Fill(fabs(pair->qInv())); }
//____________________________
void QinvEbyECorrFctn::AddMixedPair(const StHbtPair* pair) { mDenominator->Fill(fabs(pair->qInv())); }
//_____________________________
void QinvEbyECorrFctn::SetCorrection(const StHbt1DHisto* correc) { mCorrection = (StHbt1DHisto*)correc; }
//_____________________________
...
double QinvEbyECorrFctn::Norm_by_fit(double min_GeV = 0.1, double max_GeV = 0.2) {
   ...
   if (m_Debug_ebye) {
      ...
      cout << "Fit result line fit, norm : " << mRatio->GetFunction("line")->GetParameter(0) << "  "
           << mRatio->GetFunction("line")->GetParameter(1) << endl;
   }
