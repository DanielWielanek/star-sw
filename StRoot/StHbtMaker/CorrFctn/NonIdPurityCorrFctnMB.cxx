/***************************************************************************
 *
 * $Id: NonIdPurityCorrFctnMB.cxx,v 1.4 2000/01/25 17:34:45 laue Exp $
 *
 ...
 ***************************************************************************
 *
 * $Log: NonIdPurityCorrFctnMB.cxx,v $
...
#ifdef __ROOT__
ClassImp(NonIdPurityCorrFctnMB)
#endif

    //____________________________
    NonIdPurityCorrFctnMB::NonIdPurityCorrFctnMB(char* title, const int& nbins, const float& QinvLo,
...
//____________________________
NonIdPurityCorrFctnMB::~NonIdPurityCorrFctnMB() {
   delete mNumP;
   delete mDenP;
   delete mRatP;
   delete mNumN;
...
void NonIdPurityCorrFctnMB::Finish() {
   double tScale;
...
void NonIdPurityCorrFctnMB::Write() {
   mNumP->Write();
   mDenP->Write();
   mRatP->Write();
   mNumN->Write();
...
//____________________________
StHbtString NonIdPurityCorrFctnMB::Report() {
...
//____________________________
void NonIdPurityCorrFctnMB::AddRealPair(const StHbtPair* pair) {
...
//____________________________
void NonIdPurityCorrFctnMB::AddMixedPair(const StHbtPair* pair) {
   double tKStar = fabs(pair->KStar());
   //  double tPStar = 2*fabs(pair->KStarFlipped());
   double tCVK = pair->CVK();
...
//____________________________
void NonIdPurityCorrFctnMB::AddRealPairMB(const StHbtPair* pair, int ibin) {
   double tKStar = fabs(pair->KStar());
   //  double tPStar = 2*fabs(pair->KStarFlipped());
   double tCVK = pair->CVK();
   double pPurity = 0.0;
...
//____________________________
void NonIdPurityCorrFctnMB::AddMixedPairMB(const StHbtPair* pair, int ibin) {
   double tKStar = fabs(pair->KStar());
   //  double tPStar = 2*fabs(pair->KStarFlipped());
   double tCVK = pair->CVK();
