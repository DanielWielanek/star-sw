...
ClassImp(MinvLikeSignCorrFctn_MinvYPt)
    ...
    MinvLikeSignCorrFctn_MinvYPt::MinvLikeSignCorrFctn_MinvYPt(char* title1, char* title2, const int& nxbins,
                                                               const double& xLo, const double& xHi, const int& nybins,
                                                               const double& yLo, const double& yHi, const int& nzbins,
                                                               const double& zLo, const double& zHi, const double& m0) {
...
void MinvLikeSignCorrFctn_MinvYPt::Finish() {
   ...
   mMixedEventDifferencePt->Add(mNumeratorPt, mMixedEventDenominatorPt, 1.0,
                                -1 * NumeratorInt / MixedEventDenominatorInt);
   ...
   mMixedEventDifferenceMt->Add(mNumeratorMt, mMixedEventDenominatorMt, 1.0,
                                -1 * NumeratorInt / MixedEventDenominatorInt);
...
inline void MinvLikeSignCorrFctn_MinvYPt::AddRealPair(const StHbtPair* pair) {
   mMinv = pair->mInv();
   mY = pair->fourMomentumSum().rapidity();
   mPt = pair->fourMomentumSum().vect().perp();
   mMt = ::sqrt(::pow(mMinv, 2.) + ::pow(mPt, 2.));
