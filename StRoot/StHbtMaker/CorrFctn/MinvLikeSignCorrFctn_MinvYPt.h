...
class MinvLikeSignCorrFctn_MinvYPt : public StHbtLikeSignCorrFctn {
  public:
   ...
   MinvLikeSignCorrFctn_MinvYPt(char* title1, char* title2, const int& nxbins, const double& xLo, const double& xHi,
                                const int& nybins, const double& yLo, const double& yHi, const int& nzbins,
                                const double& zLo, const double& zHi, const double& m0 = 1.019417);
...
inline MinvLikeSignCorrFctn_MinvYPt* MinvLikeSignCorrFctn_MinvYPt::Clone() {
   MinvLikeSignCorrFctn_MinvYPt* c = new MinvLikeSignCorrFctn_MinvYPt(*this);
   return c;
}
inline MinvLikeSignCorrFctn_MinvYPt::MinvLikeSignCorrFctn_MinvYPt(const MinvLikeSignCorrFctn_MinvYPt& fctn)
