...
class MinvLikeSignCorrFctn_Minv_vs_Phi : public StHbtLikeSignCorrFctn {
  public:
   ...
   MinvLikeSignCorrFctn_Minv_vs_Phi(char* title1, char* title2, const int& nxbins = 100, const float& xLo = .98,
                                    const float& xHi = 1.08, const int& nybins = 12, const float& yLo = 0.,
...
inline MinvLikeSignCorrFctn_Minv_vs_Phi* MinvLikeSignCorrFctn_Minv_vs_Phi::Clone() {
   MinvLikeSignCorrFctn_Minv_vs_Phi* c = new MinvLikeSignCorrFctn_Minv_vs_Phi(*this);
   return c;
}
inline MinvLikeSignCorrFctn_Minv_vs_Phi::MinvLikeSignCorrFctn_Minv_vs_Phi(const MinvLikeSignCorrFctn_Minv_vs_Phi& fctn)
