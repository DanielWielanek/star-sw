...
ClassImp(Q3invCorrFctn)
    ...
    Q3invCorrFctn::Q3invCorrFctn(char* title, const int& nbinsQ, const float& QinvLo, const float& QinvHi,
                                 const int& nbinsMerge, const float& MergeLo, const float& MergeHi,
                                 const float& Split) {
...
void Q3invCorrFctn::Finish() { mRatio->Divide(mNumerator, mDenominator, 1.0, 1.0); }
...
//____________________________
void Q3invCorrFctn::AddCorrection(StHbtCoulomb* correction) { mCorrection = *correction; }
