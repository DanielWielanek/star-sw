...
void NonId3DCorrFctn::makeHistos(char* title, const int& nbins, const float& QinvLo, const float& QinvHi) {
   ...
   mHOutKSame = new StHbt2DHisto(strcat(htitle, title), htitle, 100, -klim, klim, nbins, QinvLo, kstarlim);
   strcpy(htitle, "HOutKDiff");
   mHOutKDiff = new StHbt2DHisto(strcat(htitle, title), htitle, 100, -klim, klim, nbins, QinvLo, kstarlim);
   strcpy(htitle, "HSideKSame");
   mHSideKSame = new StHbt2DHisto(strcat(htitle, title), htitle, 100, -klim, klim, nbins, QinvLo, kstarlim);
   strcpy(htitle, "HSideKDiff");
   mHSideKDiff = new StHbt2DHisto(strcat(htitle, title), htitle, 100, -klim, klim, nbins, QinvLo, kstarlim);
   strcpy(htitle, "HLongKSame");
   mHLongKSame = new StHbt2DHisto(strcat(htitle, title), htitle, 100, -klim, klim, nbins, QinvLo, kstarlim);
   strcpy(htitle, "HLongKDiff");
   mHLongKDiff = new StHbt2DHisto(strcat(htitle, title), htitle, 100, -klim, klim, nbins, QinvLo, kstarlim);
