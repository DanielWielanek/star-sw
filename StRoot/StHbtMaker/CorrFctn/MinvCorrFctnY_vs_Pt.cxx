...
ClassImp(MinvCorrFctnY_vs_Pt)
    ...
    MinvCorrFctnY_vs_Pt::MinvCorrFctnY_vs_Pt(char* title, const int& nbins1, const float& MinvLo1, const float& MinvHi1,
                                             const int& nbins2, const float& MinvLo2, const float& MinvHi2) {
   char theTitle[100];
   // set up numerator
   const char* TitNum = "MinvCorrFctnY_vs_Pt_Num";
   ...
   // set up difference
   const char* TitDif = "MinvCorrFctnY_vs_Pt_Dif";
