...
class MinvLikeSignCorrFctn_Minv_vs_Pt : public StHbtLikeSignCorrFctn {
  public:
   ...
   MinvLikeSignCorrFctn_Minv_vs_Pt(char* title1, char* title2, const int& nxbins, const float& xLo, const float& xHi,
...
inline MinvLikeSignCorrFctn_Minv_vs_Pt* MinvLikeSignCorrFctn_Minv_vs_Pt::Clone() {
   MinvLikeSignCorrFctn_Minv_vs_Pt* c = new MinvLikeSignCorrFctn_Minv_vs_Pt(*this);
   return c;
}
inline MinvLikeSignCorrFctn_Minv_vs_Pt::MinvLikeSignCorrFctn_Minv_vs_Pt(const MinvLikeSignCorrFctn_Minv_vs_Pt& fctn)
