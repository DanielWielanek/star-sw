...
class MinvCorrFctnArmenteros : public StHbtCorrFctn {
  public:
   MinvCorrFctnArmenteros(char* title, const int& nbins1, const float& MinvLo1, const float& MinvHi1, const int& nbins2,
...
inline void MinvCorrFctnArmenteros::SetMassWindow(double a, double b) {
   mLo = a;
   mHi = b;
}
...
inline MinvCorrFctnArmenteros* MinvCorrFctnArmenteros::Clone() {
   MinvCorrFctnArmenteros* c = new MinvCorrFctnArmenteros(*this);
   return c;
}
