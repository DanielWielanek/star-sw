...
ClassImp(MinvLikeSignCorrFctn)
    ...
    MinvLikeSignCorrFctn::MinvLikeSignCorrFctn(char* title1, char* title2, const int& nbins, const float& MinvLo,
                                               const float& MinvHi) {
#ifdef __ROOT__
...
//____________________________
inline void MinvLikeSignCorrFctn::AddRealPair(const StHbtPair* pair) { mNumerator->Fill(pair->mInv()); }
//____________________________
inline void MinvLikeSignCorrFctn::AddMixedPair(const StHbtPair* pair) { mMixedEventDenominator->Fill(pair->mInv()); }
//____________________________
