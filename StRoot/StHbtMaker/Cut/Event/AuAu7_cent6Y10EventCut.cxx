#include "StHbtMaker/Cut/Event/AuAu7_cent6Y10EventCut.h"
...
#ifdef __ROOT__
ClassImp(AuAu7_cent6Y10EventCut)
#endif
...
double AuAu7_cent6Y10EventCut::getEtaSym(const StHbtEvent* event) {
...
bool AuAu7_cent6Y10EventCut::Pass(const StHbtEvent* event) {
   ...
   cout << "AuAu7_cent6Y10EventCut:: VertexZPos: " << mVertZPos[0] << " < " << VertexZPos << " < " << mVertZPos[1]
        << endl;
   ...
   cout << "AuAu7_cent6Y10EventCut::event->TriggerWord() = " << event->TriggerWord() << endl;
   cout << "AuAu7_cent6Y10EventCut::event->TriggerActionWord() = " << event->TriggerActionWord() << endl;
   ...
   if (goodEvent) {
      ...
      cout << "AuAu7_cent6Y10EventCut:: TPC multiplicity: " << mEventMult[0] << " < " << multTPC << " < "
           << mEventMult[1] << endl;
      cout << "AuAu7_cent6Y10EventCut:: FTPC east multiplicity: " << mFtpcEventMult[0] << " <= " << multFTPCeast
   ...
   cout << "AuAu7_cent6Y10EventCut:: return : " << goodEvent << endl;

   return (goodEvent);
}

//------------------------------
StHbtString AuAu7_cent6Y10EventCut::Report() {
   string Stemp;
   char Ctemp[400];
