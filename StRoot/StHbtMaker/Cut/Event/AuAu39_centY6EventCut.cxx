#include "StHbtMaker/Cut/Event/AuAu39_centY6EventCut.h"
...
#ifdef __ROOT__
ClassImp(AuAu39_centY6EventCut)
#endif
...
double AuAu39_centY6EventCut::getEtaSym(const StHbtEvent* event) {
...
bool AuAu39_centY6EventCut::Pass(const StHbtEvent* event) {
 ...
 */
   ...
   */
   ...
   cout << "AuAu39_centY6EventCut:: VertexZPos: " << mVertZPos[0] << " < " << VertexZPos << " < " << mVertZPos[1]
        << endl;
   cout << "AuAu39_centY6EventCut:: etaSym: " << etaSym << endl;
   ...
   cout << "AuAu39_centY6EventCut::event->TriggerWord() = " << event->TriggerWord() << endl;
   cout << "AuAu39_centY6EventCut::event->TriggerActionWord() = " << event->TriggerActionWord() << endl;
   bool goodEvent =
   ...
   if (goodEvent) {
      ...
      cout << "AuAu39_centY6EventCut:: TPC multiplicity: " << mEventMult[0] << " < " << multTPC << " < "
           << mEventMult[1] << endl;
      cout << "AuAu39_centY6EventCut:: FTPC east multiplicity: " << mFtpcEventMult[0] << " <= " << multFTPCeast
   ...
   cout << "AuAu39_centY6EventCut:: return : " << goodEvent << endl;

   return (goodEvent);
}

//------------------------------
StHbtString AuAu39_centY6EventCut::Report() {
   string Stemp;
   char Ctemp[400];
