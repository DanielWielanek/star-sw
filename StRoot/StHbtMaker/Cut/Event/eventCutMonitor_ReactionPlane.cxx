#include "StHbtMaker/Cut/Event/eventCutMonitor_ReactionPlane.h"
...
ClassImp(eventCutMonitor_ReactionPlane)
   ...
   mMultReactionPlaneError = new StHbt2DHisto("Mult_vs_ReactionPlaneError", "Mult_vs_ReactionPlaneError", 36, 0.,
                                              2. * asin(1.), 100, 0, 5.e2);
}
//------------------------------
eventCutMonitor_ReactionPlane::eventCutMonitor_ReactionPlane(const char* title1, const char* title2, int nbins,
