...
class anglePairCut : public StHbtPairCut {
  public:
   ...
   void SetAngleCut(const double& angleLo1, const double& angleHi1, const double& angleLo2, const double& angleHi2);
   StHbt1DHisto* betaT();
   StHbt1DHisto* betaL();
   StHbt1DHisto* betaT2();
   StHbt1DHisto* betaL2();
...
inline anglePairCut* anglePairCut::Clone() {
   anglePairCut* c = new anglePairCut(*this);
   return c;
}
...
inline void anglePairCut::SetAngleCut(const double& angleLo1, const double& angleHi1, const double& angleLo2,
                                      const double& angleHi2) {
   mAngle1[0] = angleLo1;
   mAngle1[1] = angleHi1;
   mAngle2[0] = angleLo2;
   mAngle2[1] = angleHi2;
