...
inline void helensLaPTrackCut::SetNSigmaElectron(const float& lo, const float& hi) {
   mNSigmaElectron[0] = lo;
   mNSigmaElectron[1] = hi;
}
inline void helensLaPTrackCut::SetNSigmaPion(const float& lo, const float& hi) {
   mNSigmaPion[0] = lo;
   mNSigmaPion[1] = hi;
}
inline void helensLaPTrackCut::SetNSigmaKaon(const float& lo, const float& hi) {
   mNSigmaKaon[0] = lo;
   mNSigmaKaon[1] = hi;
}
inline void helensLaPTrackCut::SetNSigmaProton(const float& lo, const float& hi) {
   mNSigmaProton[0] = lo;
   mNSigmaProton[1] = hi;
}
...
inline void helensLaPTrackCut::SetNHits(const int& lo, const int& hi) {
   mNHits[0] = lo;
   mNHits[1] = hi;
}
inline void helensLaPTrackCut::SetP(const float& lo, const float& hi) {
   mP[0] = lo;
   mP[1] = hi;
}
inline void helensLaPTrackCut::SetPt(const float& lo, const float& hi) {
   mPt[0] = lo;
   mPt[1] = hi;
}
inline void helensLaPTrackCut::SetPx(const float& lo, const float& hi) {
   mPx[0] = lo;
   mPx[1] = hi;
}
inline void helensLaPTrackCut::SetPy(const float& lo, const float& hi) {
   mPy[0] = lo;
   mPy[1] = hi;
}
inline void helensLaPTrackCut::SetPz(const float& lo, const float& hi) {
   mPz[0] = lo;
   mPz[1] = hi;
}
inline void helensLaPTrackCut::SetRapidity(const float& lo, const float& hi) {
   mRapidity[0] = lo;
   mRapidity[1] = hi;
}
inline void helensLaPTrackCut::SetDCA(const float& lo, const float& hi) {
   mDCA[0] = lo;
   mDCA[1] = hi;
}
inline void helensLaPTrackCut::SetCharge(const int& ch) { mCharge = ch; }
inline helensLaPTrackCut* helensLaPTrackCut::Clone() {
   helensLaPTrackCut* c = new helensLaPTrackCut(*this);
   return c;
}
