...
inline void franksPairCut::SetQuality(const float x, const float y) {
   mQuality[0] = x;
   mQuality[1] = y;
}
inline void franksPairCut::SetKt(const float x, const float y) {
   mKt[0] = x;
   mKt[1] = y;
}
inline void franksPairCut::SetPt(const float x, const float y) {
   mPt[0] = x;
   mPt[1] = y;
}
inline void franksPairCut::SetOpeningAngle(const float x, const float y) {
   mOpeningAngle[0] = x;
   mOpeningAngle[1] = y;
}
inline void franksPairCut::SetRapidity(const float x, const float y) {
   mRapidity[0] = x;
   mRapidity[1] = y;
}
inline void franksPairCut::SetEta(const float x, const float y) {
   mEta[0] = x;
   mEta[1] = y;
}
inline void franksPairCut::SetQinv(const float x, const float y) {
   mQinv[0] = x;
   mQinv[1] = y;
}
inline void franksPairCut::SetEntranceSeparation(const float x, const float y) {
   mEntranceSeparation[0] = x;
   mEntranceSeparation[1] = y;
}
inline void franksPairCut::SetDecayLength(const float x, const float y) {
   mDecayLength[0] = x;
   mDecayLength[1] = y;
}
inline void franksPairCut::SetAngleToPrimaryVertex(const float x, const float y) {
   mAngleToPrimaryVertex[0] = x;
   mAngleToPrimaryVertex[1] = y;
}
inline void franksPairCut::SetDcaToPrimaryVertex(const float x, const float y) {
   mDcaToPrimaryVertex[0] = x;
   mDcaToPrimaryVertex[1] = y;
}
inline void franksPairCut::SetDcaOfDaughters(const float x, const float y) {
   mDcaOfDaughters[0] = x;
   mDcaOfDaughters[1] = y;
}
...
inline franksPairCut* franksPairCut::Clone() {
   franksPairCut* c = new franksPairCut(*this);
   return c;
}
