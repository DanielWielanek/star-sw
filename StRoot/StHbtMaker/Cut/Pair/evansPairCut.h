...
inline void evansPairCut::SetAngleCut(double CutValue) { AngleCut = CutValue; }

inline void evansPairCut::SetPCutDistance(double CutValue) { pCutDistance = CutValue; }

inline evansPairCut* evansPairCut::Clone() {
   evansPairCut* c = new evansPairCut(*this);
   return c;
}
