...
#include "StHbtMaker/Cut/Pair/anglePairCut.h"
...
bool anglePairCut::Pass(const StHbtPair* pair) {
   ...
   if ((mAngle2[0] > 360.0) && (mAngle2[1] > 360.0)) {
      if (mAngle1[0] < mAngle1[1]) {
         temp1 = ((mAngle1[0] < angleDifference) && (angleDifference < mAngle1[1]));
      } else {
         temp1 = ((mAngle1[0] < angleDifference) || (angleDifference < mAngle1[1]));
      }
   }
   ...
   if ((mAngle2[0] < 360.0) || (mAngle2[1] < 360.0)) {
      if (mAngle1[0] < mAngle1[1]) {
         ...
         if (mAngle2[0] < mAngle2[1]) {
            temp2 = ((mAngle2[0] < angleDifference) && (angleDifference < mAngle2[1]));
         } else {
            temp2 = ((mAngle2[0] < angleDifference) || (angleDifference < mAngle2[1]));
         }
      } else {
