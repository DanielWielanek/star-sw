...
#include "StHbtMaker/Cut/Pair/HitMergingPairCut.h"
...
void HitMergingPairCut::setMergingPar(double aMaxDuInner, double aMaxDzInner, double aMaxDuOuter, double aMaxDzOuter) {
   StHbtPair tPair;
   tPair.setMergingPar(aMaxDuInner, aMaxDzInner, aMaxDuOuter, aMaxDzOuter);
}
