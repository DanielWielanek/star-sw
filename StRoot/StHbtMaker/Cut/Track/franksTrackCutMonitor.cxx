#include "StHbtMaker/Cut/Track/franksTrackCutMonitor.h"
...
ClassImp(franksTrackCutMonitor)
   ...
   mDCAxyGlobal =
       new StHbt1DHisto((s + n + "mDCAxyGlobal").c_str(), "Momentum (GeV/c) vs Energy loss (a.u.)", 1000, 0., 5.);
   mPvsDedx = new StHbt2DHisto((s + n + "mPvsDedx").c_str(), "Momentum (GeV/c) vs Energy loss (a.u.)", 100, -3., 3., 50,
                               0., 5e-6);
}
