#include "StHbtMaker/Cut/Track/v0CutMonitor_Minv.h"
...
//------------------------------
v0CutMonitor_Minv::v0CutMonitor_Minv(const char* TitCutMoni, const char* title, int nbins, double min, double max) {
