#include "StHbtMaker/Cut/Track/trackCutMonitor_P_vs_Dedx.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
trackCutMonitor_P_vs_Dedx::trackCutMonitor_P_vs_Dedx(int charge, const char* TitCutMoni, const char* title, int nbins1,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
trackCutMonitor_P_vs_Dedx::~trackCutMonitor_P_vs_Dedx() { delete mHisto; }
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
void trackCutMonitor_P_vs_Dedx::Fill(const StHbtTrack* track) {
   if (track->Charge() == mCharge || mCharge == 0) mHisto->Fill(abs(track->P()), track->dEdx(), 1.);
}
