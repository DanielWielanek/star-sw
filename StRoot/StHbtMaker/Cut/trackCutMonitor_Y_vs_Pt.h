...
class trackCutMonitor_Y_vs_Pt : public StHbtCutMonitor {
  ...
  public:
   ...
   trackCutMonitor_Y_vs_Pt(double aMass, const char* TitCutMoni, const char* title, int nbins1, double min1,
                           double max1, int nbins2, double min2, double max2);
   trackCutMonitor_Y_vs_Pt(const char* TitCutMoni, const char* title, int nbins1, double min1, double max1, int nbins2,
