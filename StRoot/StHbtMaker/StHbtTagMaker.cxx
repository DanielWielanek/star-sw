...
ClassImp(StHbtTagMaker)
    ...
    //-------------------------------------------------------------
    StHbtTagMaker::StHbtTagMaker(const Char_t* name)
    : StMaker(name) {
   mHbtTag = 0;
   mSt_HbtTag = 0;
   mShowTags = 0;
...
//-------------------------------------------------------------
Int_t StHbtTagMaker::Init() { return StMaker::Init(); }
//-------------------------------------------------------------
...
//-------------------------------------------------------------
void StHbtTagMaker::Fill(StHbtTagWriter* writer) { *mHbtTag = writer->mHbtTag; }
//-------------------------------------------------------------
...
Int_t StHbtTagMaker::Finish() { return StMaker::Finish(); }
