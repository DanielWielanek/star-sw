...
StHbtEvent* StHbtFlowPicoReader::ReturnHbtEvent() {
 ...
 http://www.star.bnl.gov/webdatanfs/dox/html/StHbtEvent_8cc-source.html
   ...
   cout << "StHbtFlowPicoReader::ReturnHbtEvent() crrnt_entry begins " << crrnt_entry << "\n";
   int ientry;
   if (crrnt_entry < Nentries) {
      ientry = this->pDST->LoadTree(crrnt_entry);
      nb = this->pDST->fChain->GetEntry(crrnt_entry);
      Nbytes += nb;
         ...
         if (!reject) {
          ...
          atan changes between -Pi/2 and Pi/2.
            */
            ...
            const StPhysicalHelixD& mHelix = StPhysicalHelixD(tmpP, VertexPosition, BTesla * tesla, charge);
...
StHbtString StHbtFlowPicoReader::Report() { return (StHbtString) " Here is the reader report \n"; }
///////////////////////////////////////////////////////////////////
