...
StHbtEvent* StHbtStrangeMuDstEventReader::ReturnHbtEvent() {
   ...
   StHbtThreeVector vp = StHbtThreeVector(strangeEvMuDst->primaryVertexX(), strangeEvMuDst->primaryVertexY(),
                                          strangeEvMuDst->primaryVertexZ());
   ...
   printf(" StHbtStrangeMuDstEventReader::ReturnHbtEvent() - %8i(%i) V0s pushed into collection \n",
          hbtEvent->V0Collection()->size(), mStrangeMuDstMaker->GetNV0());
