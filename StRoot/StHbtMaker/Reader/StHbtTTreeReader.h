...
class StHbtTTreeReader : public StHbtEventReader {
  ...
  protected:
  public:
   StHbtTTreeReader(StHbtIOMode mode, StIOMaker* io, const char* dirName, const char* fileName,
                    const char* extention = ".hbtTTreeMuDst", const char* filter = ".", int maxFiles = 99999);
