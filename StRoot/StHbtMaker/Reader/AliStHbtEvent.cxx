...
int AliStHbtEvent::GetRunNumber() { return mRunNumber; }

void AliStHbtEvent::SetRunNumber(int number) { mRunNumber = number; }

int AliStHbtEvent::GetEventNumber() { return mEventNumber; }

void AliStHbtEvent::SetEventNumber(int number) { mEventNumber = number; }
