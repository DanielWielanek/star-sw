  ...
  public:
   ...
   StHbtEvtGenHiddenInfo(const StHbtLorentzVector& aFreezeOutMomEn, const int& aStatus, const int& aPdgPid)
       : mEmPoint(0, 0, 0, 0),
         ...
         mStatus(aStatus),
         mPdgPid(aPdgPid),
         mPosHaveNotBeenModified(1){};
   StHbtEvtGenHiddenInfo(const StHbtLorentzVector& aEmPoint, const StHbtLorentzVector& aFreezeOutMomEn,
...
inline StHbtLorentzVector* StHbtEvtGenHiddenInfo::getEmPoint() { return &mEmPoint; }
inline StHbtLorentzVector* StHbtEvtGenHiddenInfo::getFreezeOutMomEn() { return &mFreezeOutMomEn; }
inline const StHbtLorentzVector* StHbtEvtGenHiddenInfo::getEmPoint() const { return &mEmPoint; }
inline const StHbtLorentzVector* StHbtEvtGenHiddenInfo::getFreezeOutMomEn() const { return &mFreezeOutMomEn; }
...
inline void StHbtEvtGenHiddenInfo::setEmPoint(const StHbtLorentzVector& aEmPoint) { mEmPoint = aEmPoint; }
inline void StHbtEvtGenHiddenInfo::setFreezeOutMomEn(const StHbtLorentzVector& aFreezeOutMomEn) {
   mFreezeOutMomEn = aFreezeOutMomEn;
}
inline void StHbtEvtGenHiddenInfo::setStatus(int aStatus) { mStatus = aStatus; }
inline void StHbtEvtGenHiddenInfo::setPdgPid(int aPdgPid) { mPdgPid = aPdgPid; }
inline void StHbtEvtGenHiddenInfo::setPid(int aPdgPid) { mPdgPid = aPdgPid; }
...
inline int StHbtEvtGenHiddenInfo::posHaveNotBeenModified() const { return mPosHaveNotBeenModified; }
inline void StHbtEvtGenHiddenInfo::setPosHaveBeenModified() { mPosHaveNotBeenModified = 0; }
#endif
