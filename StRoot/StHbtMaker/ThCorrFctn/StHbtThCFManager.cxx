...
StHbtThCFManager::~StHbtThCFManager(){/* no-op */};
...
void StHbtThCFManager::AddRealPair(const StHbtPair*){/* do nothing*/};
...
inline void StHbtThCFManager::AddCorrFctn(StHbtThCorrFctn* aCorrFctn) { mThCorrFctnColl.push_back(aCorrFctn); };
