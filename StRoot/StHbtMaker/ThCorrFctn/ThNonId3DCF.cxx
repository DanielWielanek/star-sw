...
ClassImp(ThNonId3DCF)
   ...
   mRatSideNOverP = new StHbt1DHisto(TitRatSideNOverP, title, nbins, QinvLo, QinvHi);
   ...
   mHOutKSame = new StHbt2DHisto("HOutKSame", "HOutKSame", 100, -klim, klim, nbins, QinvLo, QinvHi);
   mHOutKDiff = new StHbt2DHisto("HOutKDiff", "HOutKDiff", 100, -klim, klim, nbins, QinvLo, QinvHi);
   mHSideKSame = new StHbt2DHisto("HSideKSame", "HSideKSame", 100, -klim, klim, nbins, QinvLo, QinvHi);
   mHSideKDiff = new StHbt2DHisto("HSideKDiff", "HSideKDiff", 100, -klim, klim, nbins, QinvLo, QinvHi);
   mHLongKSame = new StHbt2DHisto("HLongKSame", "HLongKSame", 100, -klim, klim, nbins, QinvLo, QinvHi);
   mHLongKDiff = new StHbt2DHisto("HLongKDiff", "HLongKDiff", 100, -klim, klim, nbins, QinvLo, QinvHi);
};
...
void ThNonId3DCF::AddNum(StHbtThPair* aThPair) {
   ...
   if ((aThPair->Betat() < mBtMax) && (aThPair->Betat() > mBtMin) && (aThPair->Ut() < mUtMax) &&
       (aThPair->Ut() > mUtMin)) {
      if (tKOut > 0.) {
