...
StHbtFsiLednickyPurity::~StHbtFsiLednickyPurity(){/* no-op */};

inline void StHbtFsiLednickyPurity::SetPurity(const double aPurity) {
   mPurity1 = aPurity;
   mPurity2 = aPurity;
}
inline void StHbtFsiLednickyPurity::SetPurity(const double aPurity1, const double aPurity2) {
   mPurity1 = aPurity1;
   mPurity2 = aPurity2;
}
