...
ClassImp(StHbtThPairEvtGen)
    ...
    StHbtThPairEvtGen::StHbtThPairEvtGen()
    : StHbtThPair(){/* no-op */};

void StHbtThPairEvtGen::Set(const StHbtPair* aPair) {
   const StHbtEvtGenHiddenInfo* tEvtGenHidInf1 =
       dynamic_cast<const StHbtEvtGenHiddenInfo*>(aPair->track1()->HiddenInfo());
   const StHbtEvtGenHiddenInfo* tEvtGenHidInf2 =
       dynamic_cast<const StHbtEvtGenHiddenInfo*>(aPair->track2()->HiddenInfo());
