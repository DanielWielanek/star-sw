...
void StHbtEvtGenPair::setVariables(const StHbtPair* aPair) {
   ...
   tEvtGenHiddenInfoV[0] = (StHbtEvtGenHiddenInfo*)(aPair->track1()->getHiddenInfo());
   tEvtGenHiddenInfoV[1] = (StHbtEvtGenHiddenInfo*)(aPair->track2()->getHiddenInfo());
   ...
   for (int ti = 0; ti < 2; ti++) {
      ...
      if (tEvtGenHiddenInfo->posHaveNotBeenModified()) {
         ...
         switch (mDecoralate) {
            ...
            {
               if (ti == 1) tEmPoint->setT(tEmPoint->t() + tTimeShift / mMomentum2->e() * mMomentum2->mt());
               break;
            }
            case 4:  // both 1 and 3
            {
